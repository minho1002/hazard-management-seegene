...
// /admin/permissions(구 독립 페이지)에서 이동한 컴포넌트 — 로직은 그대로, /admin/users-permissions의
// "역할/권한" 탭에서 렌더링된다.
export default function PermissionsPanel() {
  ...
  return (
    <div>
      <div style={{ padding: '20px 32px 16px', borderBottom: '1px solid #e3e8ef', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
